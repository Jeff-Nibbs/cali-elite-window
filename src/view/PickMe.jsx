...
function PickMe() {
  return (
    <div className='lg:flex lg:justify-center lg:items-center lg:flex-col relative text-center p-5 text-neutral-200 font-prompt font-bold bg-[url("./assets/nook-room.jpg")] min-h-screen bg-no-repeat bg-cover bg-center bg-fixed bg-gray-500 bg-blend-multiply'>
      ...
      <div className='md:flex justify-center mt-20 gap-10'>
        <div className='bg-neutral-800 bg-opacity-70 max-w-md shadow rounded-xl p-5 my-7'>
          <FiHeart className='text-5xl m-auto text-red-500' />
        ...
        <div className='bg-neutral-800 bg-opacity-70 max-w-md shadow rounded-xl p-5 my-7'>
          <FaHandshake className='text-5xl m-auto text-blue-500' />
        ...
        <div className='bg-neutral-800 bg-opacity-70 max-w-md shadow rounded-xl p-5 my-7'>
          <FiHome className='text-5xl m-auto text-green-500' />
